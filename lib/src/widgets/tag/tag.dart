...
class MoonRawTag extends StatelessWidget {
  ...
  /// The callback that is called when the tag is tapped or otherwise activated.
  ///
  /// If this callback and [onLongPress] are null, then tag will be disabled automatically.
  final VoidCallback? onPress;

  /// The callback that is called when the tag is long-pressed.
  ///
  /// If this callback and [onPress] are null, then tag will be disabled automatically.
