...
void main() {
  ...
  testWidgets("Multi select widget initializes with the correct value", (
    ...
    await tester.pumpWidget(const _BaseMultiSelectTestWidget(value: true));
  ...
  testWidgets("Multi select widget changes state when tapped", (
    ...
    await tester.pumpWidget(
      _BaseMultiSelectTestWidget(onChanged: (value) => checkboxValue = value),
    );
  ...
  testWidgets("Multi select widget is disabled when 'onChanged' is null", (
    ...
    await tester.pumpWidget(
      const _BaseMultiSelectTestWidget(customOnChangedValue: true),
    );
  ...
  testWidgets("Multi select widget has the correct semantic label", (
    ...
    await tester.pumpWidget(
      const _BaseMultiSelectTestWidget(semanticLabel: semanticLabel),
    );

    final Finder checkBoxWithSemanticLabel = find.bySemanticsLabel(
      semanticLabel,
    );
