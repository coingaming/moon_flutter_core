...
abstract class MoonBaseProgressIndicator extends StatefulWidget {
  ...
  ///
  /// A value of 0.0 indicates no progress, 1.0 indicates complete progress,
  /// and values in between represent the percentage of progress completed.
  ...
  /// defaults to the [ProgressIndicator.value] expressed as a percentage,
  ...
  /// for determinate progress indicators to announce how much progress has been
  /// made.
